...
const Navbar = ({isGridLayout, setIsGridLayout}) => {
    ...
    const [isLightModeNav, setIsLightModeNav] = useState(false);
    ...
    const toggleTheme = () => {
        ...
        if (isLightModeNav) {
            ...
            setIsLightModeNav(false);
        } else {
            navbar.style.background = "#f4f4f4";
            document.body.classList.add("lightMode");
            setIsLightModeNav(true);
        }
        ...
        <>
            <div className="navbar flex items-center justify-between px-[100px] h-[80px] bg-[#141414]">
                ...
                <div className="dropDownNavbar hidden absolute right-[60px] top-[80px] shadow-lg shadow-black/50 p-[10px] rounded-lg bg-[#1A1919] w-[150px] h-[160px]">
                    ...
                    >
                        <MdLightMode className="text-[20px]" /> {isLightModeNav ? "Dark" : "Light"} mode
                    </i>
                    <i
