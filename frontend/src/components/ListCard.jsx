  ...
  return (
    <>
      <div className="listCard mb-2 w-[full] flex items-center justify-between p-[10px] bg-[#141414] cursor-pointer rounded-lg hover:bg-[#202020]">
        ...
        <div className="listCard mb-2 w-[full] flex items-center justify-between p-[10px] bg-[#141414] cursor-pointer rounded-lg hover:bg-[#202020]">
          <img onClick={()=>{setIsCollabModelShow(true)}} className='w-[30px] cursor-pointer mr-4' src={collabImg} alt="" />
      ...
      {
        isCollabModelShow ? <div className="model fixed top-0 left-0 w-screen h-screen bg-[rgba(0,0,0,0.1)] flex justify-center items-center flex-col">
          <div className="mainModel w-[32vw] h-[25vh] bg-[#141414] rounded-lg p-[20px]">
            <h3 className='text-2xl'>Share this code with your friends</h3>
            <label>{item._id}</label>
            <h3 className='text-2xl'>{item._id}</h3> 
            <div className='flex w-full mt-5 items-center gap-[10px]'>
              <button onClick={()=>{}} className='p-[10px] rounded-lg bg-[#FF4343] text-white cursor-pointer min-w-[49%]'>Copy</button>
              <button onClick={()=>{}} className='p-[10px] rounded-lg bg-[#1A1919] text-white cursor-pointer min-w-[49%]'>Okay</button>
            </div>
          </div>
        </div> : ""
      }
